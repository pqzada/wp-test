 ...
 */
// $options[] = array(
// 		'name' => __('Slide Frase', 'options_framework_theme'),
// 		'type' => 'heading');
...
// 	$options[] = array(
// 		'name' => __('Ingrese Slogan', 'options_framework_theme'),
// 		'id' => 'slide-frase',
// 		'type' => 'editor',
 ...
 */
	...
	$options[] = array(
		'name' => __('Servicios', 'options_framework_theme'),
		'id' => 'servicios',
		'type' => 'editor',
		'settings' => $wp_editor_settings );

	$options[] = array(
		'name' =>  __('Fondo Servicios', 'options_framework_theme'),
		'desc' => __('Ingrese un imagen para esta sección', 'options_framework_theme'),
		'id' => 'fondo-servicio',
		'std' => $background_defaults,
		'type' => 'background' );

	$options[] = array(
		'name' => __('Ofertas', 'options_framework_theme'),
		'id' => 'ofertas',
		'type' => 'editor',
		'settings' => $wp_editor_settings );

	$options[] = array(
		'name' =>  __('Fondo Ofertas', 'options_framework_theme'),
		'desc' => __('Ingrese un imagen para esta sección', 'options_framework_theme'),
		'id' => 'fondo-oferta',
		'std' => $background_defaults,
		'type' => 'background' );
 ...
 */
	...
	$options[] = array(
		'name' =>  __('Ingrese logo de la red social', 'options_framework_theme'),
		// 'desc' => __('Ingrese un imagen para esta sección', 'options_framework_theme'),
		'id' => 'redsocial-uno',
		'std' => $background_defaults,
		'type' => 'background' );
	...
	$options[] = array(
		'name' => __('Ingrese URL Red social', 'options_framework_theme'),
